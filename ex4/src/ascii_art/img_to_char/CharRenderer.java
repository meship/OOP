...
public class CharRenderer {
    ...
    public static void printBoolArr(boolean[][] arr) {
        /**
         * this methode prints the char represented in
         * the array to the console
         * @param arr a boolean array that represent the black
         *            and white pixel of the char as an image
         */
        Color[][] imgPixel = new Color[arr.length][arr[0].length];
